...
const renewallogs = require("./renewallogs/renewallogs.service.js");
const membershipplans = require("./membershipplans/membershipplans.service.js");
...
module.exports = function (app) {
  ...
  app.configure(renewallogs);
  app.configure(membershipplans);
