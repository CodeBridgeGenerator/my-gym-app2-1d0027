...
import seederData from "./membershipplans.seeder.json";
...
const MembershipplansSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MembershipplansSeederDialogComponent);
