...
import SingleRenewallogsPage from "../components/app_components/RenewallogsPage/SingleRenewallogsPage";
import RenewallogProjectLayoutPage from "../components/app_components/RenewallogsPage/RenewallogProjectLayoutPage";
import SingleMembershipplansPage from "../components/app_components/MembershipplansPage/SingleMembershipplansPage";
import MembershipplanProjectLayoutPage from "../components/app_components/MembershipplansPage/MembershipplanProjectLayoutPage";
    ...
    return (
        <Routes>
            ...
            <Route path="/project" exact element={<DashboardAdminControl />} />
                ...
                // myapp
<Route path="/renewallogs/:singleRenewallogsId" exact element={<SingleRenewallogsPage />} />
<Route path="/renewallogs" exact element={<RenewallogProjectLayoutPage />} />
<Route path="/membershipplans/:singleMembershipplansId" exact element={<SingleMembershipplansPage />} />
<Route path="/membershipplans" exact element={<MembershipplanProjectLayoutPage />} />
